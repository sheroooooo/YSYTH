...
export default {
  ...
  render () {
    ...
    function getKey (row, rowIndex) {
      ...
      if (rowKey) {
        return rowKey(null, row, rowIndex)
      }
      return rowIndex
    }
    ...
    function getStyle (type, row, rowIndex, column, columnIndex) {
      ...
      if (typeof style === 'function') {
        if (certainType.row) {
          return style(null, row, rowIndex)
        }
        if (certainType.cell) {
          return style(null, row, rowIndex, column, columnIndex)
        }
      }
      return style
    }
    ...
    function getClassName (type, row, rowIndex, column, columnIndex) {
      ...
      if (certainType.row || certainType.cell) {
        ...
        if (typeof className === 'string') {
          ...
          if (certainType.row) {
            classList.push(className(null, row, rowIndex) || '')
          }
          if (certainType.cell) {
            classList.push(className(null, row, rowIndex, column, columnIndex) || '')
          }
        }
        if (certainType.row) {
    ...
    function renderCell (row, rowIndex, column, columnIndex) {
      ...
      if (this.isSelectionCell(this.table, columnIndex)) {
        ...
        return <Checkbox
          ...
          value={ allCheck } disabled = {this.disabled}
